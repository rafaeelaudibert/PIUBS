...
class CreateContracts < ActiveRecord::Migration[5.2]
  def self.up
    ...
    execute <<-SQL
      ...
      -- FK
      ALTER TABLE "TB_CONTRATO" ADD CONSTRAINT "FK_EMPRESA_CONTRATO" FOREIGN KEY ("CO_SEI")
        REFERENCES "TB_EMPRESA" ("CO_SEI") MATCH SIMPLE
        ON UPDATE NO ACTION ON DELETE NO ACTION;

      ALTER TABLE "TB_CONTRATO" ADD CONSTRAINT "FK_CIDADE_CONTRATO" FOREIGN KEY ("CO_CIDADE")
  ...
  def self.down
    execute <<-SQL
      ALTER TABLE "TB_CONTRATO" DROP CONSTRAINT "FK_EMPRESA_CONTRATO";
      ALTER TABLE "TB_CONTRATO" DROP CONSTRAINT "FK_CIDADE_CONTRATO";
